...
const products = [
    {
        ...
        moq: '1 × 20ft FCL',
        status: 'Published',
        description: 'Premium compressed coco peat blocks — ideal for nurseries, hydroponic growers and greenhouse farming worldwide.',
    ...
    },
    {
        ...
        moq: '1 × 20ft FCL',
        status: 'Published',
        description: 'Washed and buffered for superior electrical conductivity — perfect for propagation and modern soilless crops.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '1 × 20ft FCL',
        status: 'Published',
        description: 'Concentrated nutrient-retaining substrate for substrate and soil-climate agriculture applications.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '5,000 pcs / order',
        status: 'Published',
        description: 'Compact mini-briquettes for nurseries, hobby growers and small commercial operations. Retail-pack ready.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '1 × 20ft FCL',
        status: 'Published',
        description: 'Fine-grade pith blocks for soil amendment, mulching and organic farming applications worldwide.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '1 × 20ft FCL',
        status: 'Published',
        description: 'Long-strand coconut fibre extracted from mature husks — used in erosion control, geotextiles and horticulture.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '1 × 40ft FCL',
        status: 'Published',
        description: 'Machine-pressed bales for bulk export. Ideal for mattress, brush, and geotextile manufacturing industries.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '1 × 20ft FCL',
        status: 'Published',
        description: 'Chunky coir husk chips with excellent aeration — the preferred substrate for orchids and tropical plants.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '1 × 40ft FCL',
        status: 'Published',
        description: 'Ready-to-use grow slabs and bags engineered for high-wire tomato, cucumber and pepper production systems.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
    ...
    },
    {
        ...
        moq: '1 × 20ft FCL',
        status: 'Published',
        description: 'White-label and OEM packing solutions for international distributors. Bulk, retail, and private-label options.',
        images: JSON.stringify([]),
        specs: JSON.stringify([
...
async function main() {
    ...
    for (const p of products) {
        try {
            await prisma_1.prisma.product.create({ data: p });
